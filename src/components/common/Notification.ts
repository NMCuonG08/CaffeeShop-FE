...
return Swal.fire({
  ...
  didOpen: () => {
    ...
    if (confirmBtn) {
      confirmBtn.style.setProperty('background-color', confirmButtonColor, 'important');
      confirmBtn.style.setProperty('border-color', confirmButtonColor, 'important');
    }
    
    if (cancelBtn) {
      cancelBtn.style.setProperty('background-color', cancelButtonColor, 'important');
      cancelBtn.style.setProperty('border-color', cancelButtonColor, 'important');
    }
  }
});
}
